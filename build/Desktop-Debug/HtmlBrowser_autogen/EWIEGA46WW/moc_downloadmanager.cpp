...
struct qt_meta_stringdata_CLASSDownloadManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDownloadManagerENDCLASS = QtMocHelpers::stringData(
    "DownloadManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDownloadManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DownloadManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDownloadManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDownloadManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDownloadManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DownloadManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDownloadManagerENDCLASS.stringdata0))
